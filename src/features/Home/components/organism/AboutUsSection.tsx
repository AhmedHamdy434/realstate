...
const AboutUsSection = () => {
  ...
  return (
    <div className="mt-6.5 mb-25 tracking-[0.25%]">
      <div className="container relative flex flex-col lg:flex-row justify-between items-center gap-14 sm:pt-24">
        ...
        <div className="image-side hidden sm:block lg:w-1/2 relative">
          <div className="rate bg-white shadow-[35px_35px_65px_0px_rgba(146,106,120,0.16)] absolute -top-24 start-[16%] flex flex-col items-center px-8">
            <img
              src={TickSquare}
              alt="TickSquare"
        ...
        <div className="text-side flex-1">
          <h6 className="bg-[rgba(248,249,254,1)] w-fit px-6 py-3 text-lg leading-6.5 font-medium text-main mb-4">
            ABOUT US
          </h6>
          <h2 className="text-main text-5xl leading-14 font-semibold mb-4">
            How much is your property worth now?
          </h2>
          <p className="text-maingray opacity-[.88] leading-6.5 mb-12">
